#!/usr/bin/ruby
# ----------------------------------------------------
# spits out ascii chars and hex/octal/dec values thereof
# tables taken straight from 'man ascii' on ubuntu 11.04
# ----------------------------------------------------
...
ascii_long = <<-'THEEND'
       ...
       013   11    0B    VT       (vertical tab)     113   75    4B    K
       014   12    0C    FF       (form feed)        114   76    4C    L
